...
LAUNCHER_APPID="org.Cloudlauncher.Cloudlauncher"
...
if command -v "inkscape" && command -v "icotool" && command -v "oxipng"; then
    ...
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_16.png" 16 16
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_24.png" 24 24
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_32.png" 32 32
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_48.png" 48 48
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_64.png" 64 64
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_128.png" 128 128
    svg2png ${LAUNCHER_APPID}.svg "$d/Cloudlauncher_256.png" 256 256

    oxipng --opt max --strip all --alpha --interlace 0 "$d/Cloudlauncher_"*".png"

    rm Cloudlauncher.ico && icotool -o Cloudlauncher.ico -c \
        "$d/Cloudlauncher_256.png"  \
        "$d/Cloudlauncher_128.png"  \
        "$d/Cloudlauncher_64.png"   \
        "$d/Cloudlauncher_48.png"   \
        "$d/Cloudlauncher_32.png"   \
        "$d/Cloudlauncher_24.png"   \
        "$d/Cloudlauncher_16.png"
else
