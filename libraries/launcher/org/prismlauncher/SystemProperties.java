package org.Cloudlauncher;

import org.Cloudlauncher.utils.Parameters;
...
public final class SystemProperties {
    public static void apply(Parameters params) {
        ...
        if (name != null)
            System.setProperty("org.Cloudlauncher.instance.name", name);
        if (iconId != null)
            System.setProperty("org.Cloudlauncher.instance.icon.id", iconId);
        if (iconPath != null)
            System.setProperty("org.Cloudlauncher.instance.icon.path", iconPath);
        if (windowTitle != null)
            System.setProperty("org.Cloudlauncher.window.title", windowTitle);
        if (windowDimensions != null)
            System.setProperty("org.Cloudlauncher.window.dimensions", windowDimensions);
