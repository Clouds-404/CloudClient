...
#define Cloud_EXTERNAL_EXE
#include "FileSystem.h"

#include "GitHubRelease.h"

class CloudUpdaterApp : public QApplication {
    Q_OBJECT
   public:
    enum Status { Starting, Failed, Succeeded, Initialized, Aborted };
    CloudUpdaterApp(int& argc, char** argv);
    virtual ~CloudUpdaterApp();
   ...
   private:
    ...
    bool loadCloudVersionFromExe(const QString& exe_path);
   ...
   private:
    ...
    QString m_CloudBinaryName;
    QString m_CloudVersion;
    int m_CloudVersionMajor = -1;
    int m_CloudVersionMinor = -1;
    int m_CloudVersionPatch = -1;
    QString m_prsimVersionChannel;
    QString m_CloudGitCommit;
