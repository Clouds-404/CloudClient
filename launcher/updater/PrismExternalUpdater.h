...
class CloudExternalUpdater : public ExternalUpdater {
    Q_OBJECT

   public:
    CloudExternalUpdater(QWidget* parent, const QString& appDir, const QString& dataDir);
    ~CloudExternalUpdater() override;
