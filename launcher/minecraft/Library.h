...
class Library {
   ...
   private: /* methods */
    /// the default storage prefix used by Cloud Launcher
   ...
   protected: /* data */
    ...
    /// DEPRECATED: Cloud Launcher-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// Cloud Launcher extension - filename override
    QString m_filename;

    /// DEPRECATED Cloud Launcher extension - display name
    QString m_displayname;

    /**
     * Cloud Launcher-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in Cloud Launcher, but could be elsewhere
     * Cloud Launcher specific, because of FTB.
     */
